...
export class SolicitarTurnoComponent implements OnInit {
  ...
  generarTurno()
  {
    ...
    this.turnoGenerado.correoUsuario = this.emailUsuario;
  ...
  turnoParaMi(){
    ...
    this.firestore.collection('usuarios').get().subscribe((querySnapShot) => {
      querySnapShot.forEach((doc) => {
       ...
       {
        this.turnoGenerado.nombre = doc.data().nombre;
        this.turnoGenerado.apellido = doc.data().apellido;
        this.turnoGenerado.DNI = doc.data().DNI;
       }
